...
import com.bhanwar.android.util.DateUtils;
...
public class ArticleDetailFragment extends Fragment
{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
	{
		...
		if (displayedArticle != null)
		{
			...
			((TextView) rootView.findViewById(R.id.article_detail)).setText(Html.fromHtml(content + "<br/> More details : <br/><a href=\""
					+ displayedArticle.getGuid() + "\">" + displayedArticle.getGuid() + "</a>"));
	...
	public boolean onOptionsItemSelected(MenuItem item)
	{
		...
		else if (id == R.id.actionbar_markunread)
		{
			...
			ArticleListAdapter adapter = (ArticleListAdapter) ((ArticleListFragment) getActivity().getSupportFragmentManager().findFragmentById(
